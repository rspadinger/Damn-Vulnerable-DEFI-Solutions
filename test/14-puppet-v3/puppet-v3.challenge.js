...
describe("[Challenge] Puppet v3", function () {
    ...
    /** SET RPC URL HERE */
    const MAINNET_FORKING_URL = "ADD URL HERE"
    ...
    before(async function () {
        ...
        // Some time passes
        await time.increase(4 * 24 * 60 * 60) // 3 days in seconds
    ...
    it("Execution", async function () {
        ...
        /**Step1: Deploy Attacker & transfer tokens */
        ...
        console.log(
            ...
            ethers.utils.formatEther((await token.balanceOf(puppetV3Attacker.address)).toString())
        )
        ...
        console.log(
            ...
            ethers.utils.formatEther((await weth.balanceOf(puppetV3Attacker.address)).toString())
        )
        console.log(
        ...
        await weth.connect(player).approve(lendingPool.address, ethers.utils.parseEther("99"))
        ...
        await puppetV3Attacker.observePool([120, 0])
        console.log(
            "tickCumulatives at 120 seconds ago (before the swap)",
        ...
        console.log(
            ...
            ethers.utils.formatEther((await weth.balanceOf(uniswapPool.address)).toString())
        )
        console.log(
            "Token balance in UniswapPool",
            ethers.utils.formatEther((await token.balanceOf(uniswapPool.address)).toString())
        )
