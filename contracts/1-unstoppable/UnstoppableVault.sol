...
contract UnstoppableVault is IERC3156FlashLender, ReentrancyGuard, Owned, ERC4626 {
    ...
    function totalAssets() public view override returns (uint256) {
        assembly { // better safe than sorry
            //Slot 0 : uint256 private locked; => 2 means locked => reentrancy
            if eq(sload(0), 2) {
                mstore(0x00, 0xed3ba6a6) // 3980109478 
                revert(0x1c, 0x04) //offset : 28, size:4 => return last 4 bytes
            }
            // => assembly code is irrelevant
        }
